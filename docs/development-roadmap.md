...
| Verification | Complete | Release test passed, 121 tests after workflow/jobs phase |
...
| Test automation | Release build/test passed, 121 tests after workflow/jobs phase |
