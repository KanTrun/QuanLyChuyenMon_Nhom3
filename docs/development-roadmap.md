...
| Verification | Complete | Release test passed, 116 tests after security validation phase |
...
| Test automation | Release build/test passed, 116 tests after security validation phase |
