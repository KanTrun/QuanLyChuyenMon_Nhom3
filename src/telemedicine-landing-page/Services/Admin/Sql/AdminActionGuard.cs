...
public sealed class AdminActionGuard
{
    ...
    private static readonly Dictionary<string, string[]> PermissionAliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["SCR_PROCEDURES:APPROVE"] = [
            "PERM_APPROVE_PROC", "PERM_PROCEDURES_approve",
            "SCR_PROCEDURE_APPROVAL:APPROVE", "SCR_PROCEDURES_WORKSPACE:APPROVE"],
        ["SCR_PROCEDURES:PUBLISH"] = [
            "PERM_APPROVE_PROC", "PERM_PROCEDURES_publish",
            "SCR_PROCEDURE_APPROVAL:APPROVE", "SCR_PROCEDURE_APPROVAL:PUBLISH",
            "SCR_PROCEDURES_WORKSPACE:PUBLISH", "SCR_PROCEDURES_WORKSPACE:APPROVE"],
        ...
        ["SCR_CLINICAL:SIGN_PROTOCOL_APPLICATION"] = ["SCR_CLINICAL:EXECUTE", "PERM_CLINICAL_execute"],
